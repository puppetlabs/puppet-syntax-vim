...
syn region  puppetDefArguments  start="(" end=")" contained contains=puppetArgument,puppetString,puppetComment,puppetArgFunction
syn match   puppetArgFunction   "(.\{-})" contained contains=puppetArgument,puppetString,puppetParamSpecial
